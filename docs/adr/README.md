...
| [0025](0025-retain-the-object-closure-of-published-causal-facts.md) | Proposed | Retain published facts' required Git objects under a shared root without granting target coverage |
