...
| `vcs-lab.amendment/v1` | [amendment.v1.schema.json](amendment.v1.schema.json) | Divergence an interactive `edit` recorded under a retained identity |
| `vcs-lab.interactive-absorption/v1` | [interactive-absorption.v1.schema.json](interactive-absorption.v1.schema.json) | Identities a surviving commit absorbed through `squash` or `fixup` |
| `vcs-lab.rebase/v3` | [rebase.v3.schema.json](rebase.v3.schema.json) | Completed causal rebase receipt |
| `vcs-lab.rebase/v2` | [rebase.v2.schema.json](rebase.v2.schema.json) | Superseded; still read, and always a rewrite that declared no interactive action |
...
| `vcs-lab.rebase-operation/v3` | [rebase-operation.v3.schema.json](rebase-operation.v3.schema.json) | `rebase.json` journal |
| `vcs-lab.forecast/v2` | [forecast.v2.schema.json](forecast.v2.schema.json) | `forecasts/<id>.json` |
| `vcs-lab.rebase-forecast/v3` | [rebase-forecast.v3.schema.json](rebase-forecast.v3.schema.json) | `forecasts/<id>.json` |
...
| `vcs-lab.rebase-plan/v3` | [rebase-plan.v3.schema.json](rebase-plan.v3.schema.json) |
...
| `vcs-lab.rebase-operation/v2` | Superseded by `vcs-lab.rebase-operation/v3`. Refused rather than resumed: its queue cannot express a declared interactive action or its pause. |
